...
await modRequest(Module, "Spoiler", "🤫", spoilerMsg, spoilerMsg);
await modRequest(Module, "Pin", "📌", pinMsgApprove, pinMsgOverride);
await modRequest(Module, "Kester Bomb", "💣", kesterBomb, kesterBomb);
