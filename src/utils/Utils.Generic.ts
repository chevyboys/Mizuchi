...
const errorLog = new Discord.WebhookClient(config.webhooks.find(webhook => webhook.name == "error") as unknown as Discord.WebhookClientData);
...
export const utils = {
   ...
   */
  clean: async function (msg: Discord.Message | Discord.CommandInteraction, t: number = 20000) {
    await utils.wait(t);
   ...
   */
  embed: function (data?: Discord.EmbedData | Discord.APIEmbed | undefined, suppressTimeStamp?: boolean): Discord.EmbedBuilder {
