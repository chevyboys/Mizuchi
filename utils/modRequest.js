 ...
 */
modRequest = async (Module, modRequestFunctionNameParam, modRequestFunctionEmojiParam, approvedCallback, overrideCallback, isContextMenu) => {
    if (isContextMenu) {
        Module.addEvent("ready", async () => {

            commands.push({
                    "name": modRequestFunctionNameParam,
                    "type": 3
            });
