...
async function blogHandler(force) {
  ...
  return await webhookUtil(
    (Module.client.guilds.cache.find(g => g.channels.cache.has(Module.config.snowflakes.channels.blogAnnouncements))).channels.cache.get(Module.config.snowflakes.channels.blogAnnouncements),
    "Blog Update",
    "./avatar/base.png", {
    content: `<@&${Module.config.snowflakes.roles.Updates.AllUpdates}>, <@&${Module.config.snowflakes.roles.Updates.BlogUpdates}>`,
    "allowed_mentions": {
