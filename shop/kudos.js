...
module.exports = new ShopItem(
  "Kudos",
  "Give yourself some Kudos! (This is just for fun, it doesn't actually do anything... yet)",
  3,
  2, // Assuming 1 is the ID for the main currency used in the shop, and 2 is the id for test currency we are using for this item, which doesn't actually do anything yet
  ...
  async (interaction) => {
    await interaction.reply({ content: "You have given yourself some Kudos! (This is just for fun, it doesn't actually do anything... yet)", ephemeral: true });
