...
module.exports = new ShopItem({
  ...
  description: "An \"Authentic\" Artifact Containing the Lost Powers of a Dead God, No Refunds",
  price: 20000, // the cost
  ...
  processPurchaseCallback: async (interaction) => {
    await interaction.reply({ content: "*The box you are handed is very light, and makes no sound on being shaken. Despite every effort you make, the item inside can't be perceived. Must be quite powerful indeed.*", ephemeral: false });
