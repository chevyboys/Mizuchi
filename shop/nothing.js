...
module.exports = new ShopItem(
  "Literally Nothing",
  "An \"Authentic\" Ancient Relic of a Bygone Age, No Refunds",
  1000, // the cost
  ...
  async (interaction) => {
    await interaction.reply({ content: "*you are handed a seemingly empty box*. Ah yes, one of our finest ancient relics. Enjoy", ephemeral: false });
